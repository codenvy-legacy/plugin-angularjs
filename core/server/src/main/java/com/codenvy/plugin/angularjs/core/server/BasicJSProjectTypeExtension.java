...
@Singleton
public class BasicJSProjectTypeExtension implements ProjectTypeExtension {
    ...
    public ProjectType getProjectType() {
        return new ProjectType("BasicJS", "BasicJS (javascript)", "JavaScript");
    }
    ...
    public List<Attribute> getPredefinedAttributes() {
        ...
        list.add(new Attribute(Constants.FRAMEWORK, "BasicJS"));
        return list;
    }
