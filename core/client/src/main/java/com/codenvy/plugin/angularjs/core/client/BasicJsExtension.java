...
public class BasicJsExtension extends JsExtension {
    ...
    @Inject
    public BasicJsExtension(IconRegistry iconRegistry, AngularJSResources resources, ProjectTypeWizardRegistry projectTypeWizardRegistry,
        ...
        super("BasicJS", iconRegistry, resources, projectTypeWizardRegistry, notificationManager, angularPagePresenter, runnerPagePresenter);
        ...
        projectTypeWizardRegistry.addWizard("BasicJS", wizard);
    }
}
