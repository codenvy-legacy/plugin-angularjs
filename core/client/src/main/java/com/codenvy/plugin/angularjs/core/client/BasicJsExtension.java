...
public class BasicJsExtension extends JsExtension {
    ...
    @Inject
    public BasicJsExtension(IconRegistry iconRegistry, AngularJSResources resources, NotificationManager notificationManager) {
        super("BasicJS", iconRegistry, resources, notificationManager);
    }
}
