...
public class GruntJsExtension extends JsExtension {
    ...
    @Inject
    public GruntJsExtension(IconRegistry iconRegistry, AngularJSResources resources, NotificationManager notificationManager) {
        super("GruntJS", iconRegistry, resources, notificationManager);
    }
}
